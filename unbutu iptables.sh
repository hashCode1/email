...
# Allow mysql traffic
iptables -A INPUT -p tcp --dport 3306 -s 172.20.240.11 -m state --state new -j ACCEPT
iptables -A INPUT -p tcp --dport 3306 -s 172.20.241.39 -m state --state new -j ACCEPT

# Allow ssh traffic
iptables -A INPUT -p tcp --dport 22 -s 172.20.240.11 -m state --state new -j ACCEPT

# Allow dns traffic
iptables -A INPUT -p tcp --dport 53 -s 172.20.240.0/24 -m state --state new -j ACCEPT
iptables -A INPUT -p tcp --dport 53 -s 172.20.241.0/24 -m state --state new -j ACCEPT
iptables -A INPUT -p tcp --dport 953 -s 172.20.240.0/24 -m state --state new -j ACCEPT
iptables -A INPUT -p tcp --dport 953 -s 172.20.241.0/24 -m state --state new -j ACCEPT
